                ...
                <nav className="hidden md:flex container heander-container !py-4 mx-auto justify-between items-center">
                    ...
                    <div className="flex items-center h-[48px]">
                        ...
                        <div className="cursor-pointer flex pl-7 pr-7 rounded-lg border-[1px] border-border-primary items-center h-full ml-1" onClick={() => addGlobalYOCTokenHandle()}>
                            ...
                            <div className="flex pr-2 text-lg"><span className="mr-2">{YOC_TOKEN} : </span><span className="inline-block overflow-hidden  text-ellipsis max-w-[60px]">
                                {/* ${YOCDetail ? Number(YOCDetail.price).toFixed(2) : '0.00'} */}
                                {YOCBalance ? YOCBalance.toFixed(2) : '0.00'}
                            </span></div>
                        </div>
                        <div className="flex rounded-lg text-lg border-[1px] border-border-primary items-center h-full pl-7 pr-7 ml-1">
                            <p className="whitespace-nowrap mr-3">Your Balance</p>
                            <div className="border-l border-border-primary text-md mr-5 pl-2 w-[100px]">
